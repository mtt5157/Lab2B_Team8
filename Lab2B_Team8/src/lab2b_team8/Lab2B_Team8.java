...
public class Lab2B_Team8 {
    ...
    public static void main(String[] args) {
        ...
        while(inputChoice != 0) {
          ...
          System.out.println("2 - Withdraw or Deposit");
          System.out.println("3 - Access ATM");
          inputChoice = in.nextInt();
          
          if(inputChoice == 1) {
             System.out.println("Personal or Commercial account:");
